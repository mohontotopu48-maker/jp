...
const serviceLinks = [
  { label: "Interior Plastering", href: "#services" },
  { label: "Exterior Plastering", href: "#services" },
  { label: "Skimming & Wall Smoothing", href: "#services" },
  { label: "Ceiling Plastering", href: "#services" },
  { label: "Crack Repairs", href: "#services" },
];
